 ...
 */
package de.saar.coli.amrtagging.formalisms.sdp.pas.tools;
...
public class CreateCorpus {
    ...
    private String corpusPath = "/home/matthias/Schreibtisch/Hiwi/Koller/Datensets_sammeln/SDP/sdp2014_2015/data/2015/meine_Daten/PAS-toy/toy.sdp";

    @Parameter(names = {"--outPath", "-o"}, description = "Path for output files")//, required = true)
    private String outPath = "/home/matthias/Schreibtisch/Hiwi/Koller/Datensets_sammeln/SDP/sdp2014_2015/data/2015/meine_Daten/PAS-toy/";
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, ParseException, ParserException, AlignedAMDependencyTree.ConllParserException{      
        ...
        while ((sdpGraph = gr.readGraph()) != null){
            ...
            sigBuilder.blobUtils = new PASBlobUtils();
            try {
