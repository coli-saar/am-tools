        ...
        for (Instance inst : corpus) {
            ...
            switch (version) {
                case 0:
                    ...
                    ApplyModifyGraphAlgebra alg = new ApplyModifyGraphAlgebra(amrSigBuilder.makeDecompositionSignature(graph, param));
...
//                }
                ...
                switch (version) {
                    case 0: 
                        ...
                        try {
                            AMRSignatureBuilder amrSigBuilder = new AMRSignatureBuilder();
                            alg = new ApplyModifyGraphAlgebra(amrSigBuilder.makeDecompositionSignature(graph, param));
